-- ============================================================
-- SCRIPT DE POPULAÇÃO DE DADOS FICTÍCIOS PARA TESTES (V3 - ESTRUTURA REAL)
...
-- ============================================================
-- 4. EMBARCAÇÕES (Estrutura REAL do banco - sem campos técnicos ainda)
-- ============================================================

INSERT IGNORE INTO `embarcacoes` (`id`, `nome`, `tipo`, `registro`, `proprietario`, `ano`, `observacoes`, `ativo`, `criado_por`, `criado_em`, `atualizado_em`) VALUES
('11111111-1111-1111-1111-111111111111', 'Estrela do Mar', 'ferry boat', 'REG-2024-001', 'Maria Fernanda Costa', 2023, 'Embarcação de passageiros', 1, '95eb5557-65e8-11f1-85ef-047c16b568a3', NOW(), NOW()),
('22222222-2222-2222-2222-222222222222', 'Rio Amazonas', 'rebocador', 'REG-2024-002', 'Pedro Henrique Santos', 2022, 'Rebocador de alto mar', 1, '95eb5557-65e8-11f1-85ef-047c16b568a3', NOW(), NOW()),
('33333333-3333-3333-3333-333333333333', 'Boa Esperança', 'pesqueiro', 'REG-2024-003', 'João Pedro Almeida', 2021, 'Embarcação de pesca artesanal', 1, '95eb5557-65e8-11f1-85ef-047c16b568a3', NOW(), NOW()),
('44444444-4444-4444-4444-444444444444', 'Atlântico Sul', 'carga geral', 'REG-2024-004', 'Transportes Marítimos Ltda', 2020, 'Navio de carga geral', 1, '95eb5557-65e8-11f1-85ef-047c16b568a3', NOW(), NOW()),
('55555555-5555-5555-5555-555555555555', 'Vitória Régia', 'passageiros', 'REG-2024-005', 'Navegação Amazônica S/A', 2024, 'Embarcação de passageiros para rios', 1, '95eb5557-65e8-11f1-85ef-047c16b568a3', NOW(), NOW());

-- ============================================================
-- 5. SEQUENCIAIS DE DOCUMENTOS (sem criado_em/atualizado_em)
-- ============================================================

INSERT IGNORE INTO `sequenciais_documentos` (`tipo_documento`, `ano`, `ultimo_numero`) VALUES
('CSN', 2026, 10),
('CNBL', 2026, 5),
('CNARQ', 2026, 3),
('LP', 2026, 8),
...
INSERT IGNORE INTO `vistorias` (`id`, `numero`, `embarcacao_id`, `pessoa_id`, `data_vistoria`, `status`, `observacoes`, `resultado`, `criado_por`, `criado_em`, `atualizado_em`) VALUES
('11111111-1111-1111-1111-111111111111', 'VIST-2026-001', '11111111-1111-1111-1111-111111111111', '55555555-5555-5555-5555-555555555555', '2026-06-15', 'APROVADA', 'Vistoria de rotina', 'Aprovado sem ressalvas', '95eb5557-65e8-11f1-85ef-047c16b568a3', NOW(), NOW()),
('22222222-2222-2222-2222-222222222222', 'VIST-2026-002', '22222222-2222-2222-2222-222222222222', '66666666-6666-6666-6666-666666666666', '2026-06-18', 'APROVADA', 'Vistoria para renovação', 'Aprovado com observações menores', '95eb5557-65e8-11f1-85ef-047c16b568a3', NOW(), NOW()),
('33333333-3333-3333-3333-333333333333', 'VIST-2026-003', '33333333-3333-3333-3333-333333333333', '44444444-4444-4444-4444-444444444444', '2026-06-20', 'PENDENTE', 'Primeira vistoria', NULL, '95eb5557-65e8-11f1-85ef-047c16b568a3', NOW(), NOW()),
('44444444-4444-4444-4444-444444444444', 'VIST-2026-004', '44444444-4444-4444-4444-444444444444', '77777777-7777-7777-7777-777777777777', '2026-06-22', 'REPROVADA', 'Vistoria de segurança', 'Reprovado - falhas estruturais', '95eb5557-65e8-11f1-85ef-047c16b568a3', NOW(), NOW()),
('55555555-5555-5555-5555-555555555555', 'VIST-2026-005', '55555555-5555-5555-5555-555555555555', '88888888-8888-8888-8888-888888888888', '2026-06-25', 'PENDENTE', 'Vistoria para certificação', NULL, '95eb5557-65e8-11f1-85ef-047c16b568a3', NOW(), NOW());

-- ============================================================
-- 7. AGENDAMENTOS
-- ============================================================

INSERT IGNORE INTO `agendamentos` (`id`, `embarcacao_id`, `cliente_id`, `vistoriador_id`, `tipo_vistoria`, `data_vistoria`, `hora_vistoria`, `local`, `contato_nome`, `contato_telefone`, `status`, `observacoes`, `criado_por`, `created_at`, `updated_at`) VALUES
('11111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '11111111-1111-1111-1111-111111111111', 'Vistoria Inicial', '2026-06-28', '09:00:00', 'Porto de Belém - Atracadouro 3', 'Maria Fernanda Costa', '(91) 99999-2222', 'confirmado', 'Vistoria para emissão de certificado CSN', '95eb5557-65e8-11f1-85ef-047c16b568a3', NOW(), NOW()),
('22222222-2222-2222-2222-222222222222', '22222222-2222-2222-2222-222222222222', 'cccccccc-cccc-cccc-cccc-cccccccccccc', '22222222-2222-2222-2222-222222222222', 'Vistoria Anual', '2026-06-30', '14:00:00', 'Estaleiro Naval de Belém', 'Pedro Henrique Santos', '(91) 99999-3333', 'confirmado', 'Renovação de certificado', '95eb5557-65e8-11f1-85ef-047c16b568a3', NOW(), NOW()),
('33333333-3333-3333-3333-333333333333', '33333333-3333-3333-3333-333333333333', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '33333333-3333-3333-3333-333333333333', 'Vistoria Inicial', '2026-07-02', '10:30:00', 'Porto de Belém - Atracadouro 1', 'João Pedro Almeida', '(91) 99999-1111', 'pendente', 'Primeira vistoria da embarcação', '95eb5557-65e8-11f1-85ef-047c16b568a3', NOW(), NOW()),
('44444444-4444-4444-4444-444444444444', '44444444-4444-4444-4444-444444444444', 'dddddddd-dddd-dddd-dddd-dddddddddddd', '11111111-1111-1111-1111-111111111111', 'Vistoria Especial', '2026-07-05', '08:00:00', 'Estaleiro Naval de Belém', 'Carlos Mendes', '(91) 3233-4444', 'pendente', 'Vistoria após reforma', '95eb5557-65e8-11f1-85ef-047c16b568a3', NOW(), NOW()),
('55555555-5555-5555-5555-555555555555', '55555555-5555-5555-5555-555555555555', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', '22222222-2222-2222-2222-222222222222', 'Vistoria Inicial', '2026-07-08', '11:00:00', 'Porto de Belém - Atracadouro 2', 'Ana Paula Silva', '(91) 3244-5555', 'pendente', 'Emissão de certificado CNBL', '95eb5557-65e8-11f1-85ef-047c16b568a3', NOW(), NOW());

-- ============================================================
-- 8. ORDENS DE SERVIÇO
-- ============================================================

INSERT IGNORE INTO `ordens_servico` (`id`, `numero`, `agendamento_id`, `embarcacao_id`, `cliente_id`, `vistoriador_id`, `tipo_vistoria`, `data_vistoria`, `hora_vistoria`, `local`, `contato_nome`, `contato_telefone`, `status`, `observacoes`, `criado_por`, `created_at`, `updated_at`) VALUES
('11111111-1111-1111-1111-111111111111', 'OS-2026-001', '11111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '11111111-1111-1111-1111-111111111111', 'Vistoria Inicial', '2026-06-28', '09:00:00', 'Porto de Belém - Atracadouro 3', 'Maria Fernanda Costa', '(91) 99999-2222', 'em_andamento', 'Vistoria em andamento', '95eb5557-65e8-11f1-85ef-047c16b568a3', NOW(), NOW()),
('22222222-2222-2222-2222-222222222222', 'OS-2026-002', '22222222-2222-2222-2222-222222222222', '22222222-2222-2222-2222-222222222222', 'cccccccc-cccc-cccc-cccc-cccccccccccc', '22222222-2222-2222-2222-222222222222', 'Vistoria Anual', '2026-06-30', '14:00:00', 'Estaleiro Naval de Belém', 'Pedro Henrique Santos', '(91) 99999-3333', 'executado', 'Vistoria concluída com sucesso', '95eb5557-65e8-11f1-85ef-047c16b568a3', NOW(), NOW());

-- ============================================================
-- 9. CERTIFICADOS CSN
-- ============================================================

INSERT IGNORE INTO `certificados_csn` (`id`, `numero`, `token_assinatura`, `nome_embarcacao`, `numero_inscricao`, `indicativo_chamada`, `atividades_servicos`, `tipo_embarcacao`, `ano_construcao`, `comprimento_m`, `arqueacao_bruta`, `tipo_navegacao`, `area_navegacao`, `fabricante_motor`, `potencia_kw`, `material_casco`, `autorizado_carga`, `qtd_passageiros`, `obs_passageiros`, `relatorio_numero`, `data_vistoria_seco`, `data_vistoria_flutuando`, `local_vistoria`, `acessibilidade_sim`, `acessibilidade_nao`, `data_emissao`, `data_validade`, `local_emissao`, `assinante_nome`, `assinante_titulo`, `assinante_registro`, `assinado`, `status`, `ativo`, `criado_por`, `criado_em`, `atualizado_em`) VALUES
(UUID(), 'AM-CSN-7/26', SHA2('cert7csn2026', 256), 'Estrela do Mar', 'PA-2024-001', 'PPW1234', 'transporte passageiros', 'ferry boat', '2023', 45.50, '450', 'MAR ABERTO', 'Costa Brasileira', 'MAN Diesel', '1500', 'aço', 0, 200, 'passageiros', 'REL-2026-007', '2026-06-15', '2026-06-15', 'Porto de Belém', 1, 0, '2026-06-16', '2027-06-16', 'Belém-PA', 'Rosano Souza Capitao', 'Engenheiro', 'CREA: 42.555', 0, 'rascunho', 1, '95eb5557-65e8-11f1-85ef-047c16b568a3', NOW(), NOW()),
(UUID(), 'AM-CSN-8/26', SHA2('cert8csn2026', 256), 'Rio Amazonas', 'PA-2024-002', 'PWR5678', 'rebocador', 'rebocador', '2022', 28.00, '280', 'MAR ABERTO', 'Área 1', 'Caterpillar', '800', 'aço', 1, 0, '', 'REL-2026-008', '2026-06-18', '2026-06-18', 'Estaleiro Naval', 0, 1, '2026-06-19', '2027-06-19', 'Belém-PA', 'Rosano Souza Capitao', 'Engenheiro', 'CREA: 42.555', 0, 'emitido', 1, '95eb5557-65e8-11f1-85ef-047c16b568a3', NOW(), NOW()),
(UUID(), 'AM-CSN-9/26', SHA2('cert9csn2026', 256), 'Boa Esperança', 'PA-2024-003', 'PPE9012', 'pesca artesanal', 'pesqueiro', '2021', 18.50, '85', 'COSTEIRA', 'Área 2', 'Yamaha', '150', 'alumínio', 0, 12, 'tripulantes', 'REL-2026-009', '2026-06-20', '2026-06-20', 'Porto de Belém', 0, 1, '2026-06-21', '2027-06-21', 'Belém-PA', 'Rosano Souza Capitao', 'Engenheiro', 'CREA: 42.555', 0, 'rascunho', 1, '95eb5557-65e8-11f1-85ef-047c16b568a3', NOW(), NOW());

-- ============================================================
-- 10. CERTIFICADOS CNBL
-- ============================================================
...
(UUID(), 'AM-LC-1/26', '11111111-1111-1111-1111-111111111111', SHA2('lc12026', 256), 'LC', '2024-12-15', 'Estrela do Mar', 'ferry boat', 'HULL-2024-001', 'aço', 'Bureau Veritas', 45.50, 43.00, 8.50, 4.20, 3.50, 450.00, 12, 200, 'MAR ABERTO', 'Costa Brasileira', 'transporte passageiros', 'motor diesel', 'Maria Fernanda Costa', '98765432100', 'Av. Nazaré, 456 - Belém, PA', 'Estaleiro Naval de Belém', '12345678000199', 'Rodovia BR-316, Km 5 - Ananindeua, PA', '2026-06-02', '2027-06-02', 'Belém-PA', 'Rosano Souza Capitao', 'Engenheiro', 'CREA: 42.555', 0, 'rascunho', 1, '95eb5557-65e8-11f1-85ef-047c16b568a3', NOW(), NOW()),
(UUID(), 'AM-LC-2/26', '22222222-2222-2222-2222-222222222222', SHA2('lc22026', 256), 'LA', NULL, 'Rio Amazonas', 'rebocador', 'HULL-2024-002', 'aço', 'DNV', 28.00, 25.50, 6.20, 3.80, 2.80, 280.00, 8, 0, 'MAR ABERTO', 'Área 1', 'rebocador', 'motor diesel', 'Pedro Henrique Santos', '45678912300', 'Travessa Quintino Bocaiúva, 789 - Belém, PA', 'Estaleiro Naval de Belém', '12345678000199', 'Rodovia BR-316, Km 5 - Ananindeua, PA', '2026-06-08', '2027-06-08', 'Belém-PA', 'Rosano Souza Capitao', 'Engenheiro', 'CREA: 42.555', 0, 'emitido', 1, '95eb5557-65e8-11f1-85ef-047c16b568a3', NOW(), NOW()),
(UUID(), 'AM-EC-1/26', '55555555-5555-5555-5555-555555555555', SHA2('ec12026', 256), 'LCEC', '2024-11-30', 'Vitória Régia', 'passageiros', 'HULL-2024-005', 'aço', 'Bureau Veritas', 32.00, 30.00, 7.00, 3.20, 2.50, 320.00, 10, 150, 'INTERIOR', 'Área 3', 'transporte passageiros', 'motor diesel', 'Navegação Amazônica S/A', '98765432000155', 'Av. Perimetral, 1000 - Belém, PA', 'Estaleiro Naval de Belém', '12345678000199', 'Rodovia BR-316, Km 5 - Ananindeua, PA', '2026-06-12', '2027-06-12', 'Belém-PA', 'Rosano Souza Capitao', 'Engenheiro', 'CREA: 42.555', 0, 'rascunho', 1, '95eb5557-65e8-11f1-85ef-047c16b568a3', NOW(), NOW());

-- ============================================================
-- 14. CERTIFICADOS CHT
-- ============================================================

INSERT IGNORE INTO `certificados_cht` (`id`, `numero_relatorio_ht`, `token_assinatura`, `profissional_empresa`, `cpf_cnpj`, `atividade_homologada`, `observacoes`, `data_emissao`, `assinante_nome`, `assinante_titulo`, `assinante_registro`, `assinado`, `status`, `ativo`, `criado_por`, `criado_em`, `atualizado_em`) VALUES
(UUID(), 'AM-REL-HT-1/26', SHA2('cht12026', 256), 'Carlos Engenharia Naval Ltda', '12345678000188', 'Projeto e construção de embarcações de até 50m', 'Homologação válida para projetos de embarcações de passageiros e carga', '2026-06-01', 'Rosano Souza Capitao', 'Diretor', 'Portaria nº 123/2026', 0, 'rascunho', 1, '95eb5557-65e8-11f1-85ef-047c16b568a3', NOW(), NOW()),
(UUID(), 'AM-REL-HT-2/26', SHA2('cht22026', 256), 'Ana Paula Silva - Consultoria', NULL, 'Vistoria e inspeção de embarcações', 'Homologação para vistorias técnicas', '2026-06-05', 'Rosano Souza Capitao', 'Diretor', 'Portaria nº 124/2026', 0, 'emitido', 1, '95eb5557-65e8-11f1-85ef-047c16b568a3', NOW(), NOW()),
(UUID(), 'AM-REL-HT-3/26', SHA2('cht32026', 256), 'Roberto Lima Serviços Marítimos', NULL, 'Manutenção e reparo de sistemas de propulsão', 'Especialização em motores diesel marítimos', '2026-06-10', 'Rosano Souza Capitao', 'Diretor', 'Portaria nº 125/2026', 0, 'rascunho', 1, '95eb5557-65e8-11f1-85ef-047c16b568a3', NOW(), NOW());
