-- ============================================================
-- SCRIPT DE POPULAÇÃO DE DADOS FICTÍCIOS PARA TESTES (CORRIGIDO)
...
-- Estrutura atual: sem cliente_id (será adicionado via migration)
-- ============================================================

INSERT IGNORE INTO `embarcacoes` (`id`, `nome`, `tipo`, `registro`, `proprietario`, `ano`, `comprimento_total`, `comprimento_casco`, `comprimento_lpp`, `pontal_moldado`, `boca_moldada`, `boca_maxima`, `material_casco`, `tipo_servico`, `tipo_navegacao`, `area_navegacao`, `arqueacao_bruta`, `numero_inscricao`, `porto_inscricao`, `indicativo_chamada`, `numero_tripulantes`, `numero_passageiros_n1`, `numero_passageiros_n2`, `observacoes`, `ativo`, `criado_por`, `criado_em`, `atualizado_em`) VALUES
('11111111-1111-1111-1111-111111111111', 'Estrela do Mar', 'ferry boat', 'REG-2024-001', 'Maria Fernanda Costa', 2023, 45.50, 42.00, 40.00, 4.20, 8.50, 9.00, 'aço', 'transporte passageiros', 'MAR ABERTO', 'Costa Brasileira', '450', 'PA-2024-001', 'Belém', 'PPW1234', 12, 200, 0, 'Embarcação de passageiros', 1, '95eb5557-65e8-11f1-85ef-047c16b568a3', NOW(), NOW()),
('22222222-2222-2222-2222-222222222222', 'Rio Amazonas', 'rebocador', 'REG-2024-002', 'Pedro Henrique Santos', 2022, 28.00, 25.50, 23.00, 3.80, 6.20, 6.50, 'aço', 'rebocador', 'MAR ABERTO', 'Área 1', '280', 'PA-2024-002', 'Belém', 'PWR5678', 8, 0, 0, 'Rebocador de alto mar', 1, '95eb5557-65e8-11f1-85ef-047c16b568a3', NOW(), NOW()),
('33333333-3333-3333-3333-333333333333', 'Boa Esperança', 'pesqueiro', 'REG-2024-003', 'João Pedro Almeida', 2021, 18.50, 16.00, 14.50, 2.50, 5.00, 5.30, 'alumínio', 'pesca artesanal', 'COSTEIRA', 'Área 2', '85', 'PA-2024-003', 'Belém', 'PPE9012', 5, 12, 0, 'Embarcação de pesca artesanal', 1, '95eb5557-65e8-11f1-85ef-047c16b568a3', NOW(), NOW()),
('44444444-4444-4444-4444-444444444444', 'Atlântico Sul', 'carga geral', 'REG-2024-004', 'Transportes Marítimos Ltda', 2020, 65.00, 60.00, 58.00, 5.50, 11.00, 11.50, 'aço', 'transporte carga', 'MAR ABERTO', 'Costa Brasileira', '1200', 'PA-2024-004', 'Belém', 'PPC3456', 15, 0, 0, 'Navio de carga geral', 1, '95eb5557-65e8-11f1-85ef-047c16b568a3', NOW(), NOW()),
('55555555-5555-5555-5555-555555555555', 'Vitória Régia', 'passageiros', 'REG-2024-005', 'Navegação Amazônica S/A', 2024, 32.00, 29.50, 27.00, 3.20, 7.00, 7.40, 'aço', 'transporte passageiros', 'INTERIOR', 'Área 3', '320', 'PA-2024-005', 'Belém', 'PPV7890', 10, 150, 0, 'Embarcação de passageiros para rios', 1, '95eb5557-65e8-11f1-85ef-047c16b568a3', NOW(), NOW());
