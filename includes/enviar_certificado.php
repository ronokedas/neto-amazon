...
{
    try {
        // Mapear campos comuns entre as tabelas
        $campos_comuns = "id, numero, token_assinatura, nome_embarcacao, data_emissao, data_validade, status";
        ...
        // Buscar e-mail do cliente associado à embarcação
        // Tentar via clientes_embarcacoes -> clientes
        $stmtCli = $pdo->prepare("
